...
const formSchema = z.object({
  ...
  media: z.array(z.string()).min(1, "Product image is required"),
  ...
  price: z.coerce.number().min(0.1, "Product price not valid"),
  expense: z.coerce.number().min(0.1, "Product expenses not valid"),
});
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      placeholder="Brand (e.g Samsung, Hisense)"
                      {...field}
                      onKeyDown={handleKeyPress}
                    />
                  </FormControl>
