import OrderStatusDialog from "@/components/Alert/OrderStatusDialog";
...
const OrderDetails = async ({ params }: { params: { orderId: string } }) => {
  ...
  return (
    <div className="flex flex-col p-10 gap-5">
      <p className="text-heading2-bold mb-8">Orders Details</p>
      ...
      <p className="text-base-bold">
        ...
        {orderDetails.isDelivered ? (
          <span className="text-base-medium text-green-400">Delivered</span>
        ) : (
          <>
            <span className="text-base-medium text-yellow-400">
              In Progress
            </span>
            <OrderStatusDialog orderId={params.orderId} />
          </>
        )}
      </p>
      <DataTable
